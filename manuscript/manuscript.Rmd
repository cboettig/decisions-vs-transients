...
Systems with alternative stable states [@Scheffer2001; @Carpenter] which can exhibit tipping points [@Scheffer2009; @Carpenter] are of great theoretical interest and pose unique challenges to ecological management [].  
...
\begin{equation}
V_t(X_t) = \max_{A_t \in \mathbf{A}} \sum_t \delta^t U(X_t, A_t)
\end{equation}
